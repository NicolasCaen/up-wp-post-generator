...
class ComposerStaticInit479faaac38677616551aca0b5df2d5e3
{
    ...
    public static $classMap = array (
        'Abstract_ChatGPT_Processor' => __DIR__ . '/../..' . '/includes/processors/class-abstract-chatgpt-processor.php',
        'Abstract_Content_Processor' => __DIR__ . '/../..' . '/includes/processors/class-abstract-content-processor.php',
        'Abstract_Utility' => __DIR__ . '/../..' . '/includes/utils/class-abstract-utility.php',
        'Admin_Interface' => __DIR__ . '/../..' . '/includes/class-admin-interface.php',
        'ChatGPT_API_Endpoints' => __DIR__ . '/../..' . '/includes/class-api-endpoints.php',
        'ChatGPT_Processor' => __DIR__ . '/../..' . '/includes/processors/class-chatgpt-processor.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'Markdown_Converter' => __DIR__ . '/../..' . '/includes/utils/class-markdown-converter.php',
        'Markdown_Processor' => __DIR__ . '/../..' . '/includes/processors/class-markdown-processor.php',
        ...
        'Processor_Registry' => __DIR__ . '/../..' . '/includes/class-processor-registry.php',
        'SEO_Processor' => __DIR__ . '/../..' . '/includes/processors/class-seo-processor.php',
        ...
        'Utility_Registry' => __DIR__ . '/../..' . '/includes/utils/class-utility-registry.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit479faaac38677616551aca0b5df2d5e3::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit479faaac38677616551aca0b5df2d5e3::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit479faaac38677616551aca0b5df2d5e3::$classMap;
